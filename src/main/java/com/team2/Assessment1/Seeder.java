...
//        tweet1.setTags(Arrays.asList(hashtag1, hashtag2));
...
//        tweet2.setTags(Arrays.asList(hashtag1, hashtag2));
...
//        tweet3.setTags(Arrays.asList(hashtag3, hashtag4));
